...
theorem litnum_bound_derivation_finish_gt_gt
  ...
  (hx_gt_zero_gt_coercion: x > 0 ↔ x_αβ > 0)
  (hy_gt_zero_gt_coercion: y > 0 ↔ y_αβ > 0)
  : dst := by
  have hab2 : 0 ≤ b_αβ - a_αβ := sub_nonneg.mpr hab
  have hx_gt_zero : x_αβ > 0 := hx_gt_zero_gt_coercion.mp $ hsrc_dn.mp hsrc
  have hy_gt_zero : y_αβ > 0 := by
...
theorem litnum_bound_derivation_finish
  {src dst: Prop}
  {α β αβ}
  {x : α}
  {y : β}
...
macro "litnum_bound_derivation_finish"
  ...
  hdst_dn:term
  hab:term
  hsrc_nf_and_dst_nf_equivalence:term
  hx_sub_a_sub_coercion:term
  hy_sub_b_sub_coercion:term
  hx_gt_zero_gt_coercion:term
  hy_gt_zero_gt_coercion:term
  : tactic => `(tactic| exact litnum_bound_derivation_finish_gt_gt $hsrc $hsrc_dn $hdst_dn $hab $hsrc_nf_and_dst_nf_equivalence $hx_sub_a_sub_coercion $hy_sub_b_sub_coercion $hx_gt_zero_gt_coercion $hy_gt_zero_gt_coercion)
...
macro "litnum_bound_derivation_finish"
  ...
  hy_sub_b_sub_coercion:term
  hx_gt_zero_gt_coercion:term
  hy_ge_zero_ge_coercion:term
  : tactic => `(tactic| exact litnum_bound_derivation_finish_gt_ge $hsrc $hsrc_dn $hdst_dn $hab $hsrc_nf_and_dst_nf_equivalence $hx_sub_a_sub_coercion $hy_sub_b_sub_coercion $hx_gt_zero_gt_coercion $hy_ge_zero_ge_coercion)
...
macro "litnum_bound_derivation_finish"
  ...
  hx_sub_a_sub_coercion:term
  hy_sub_b_sub_coercion:term
  hx_ge_zero_ge_coercion:term
  hy_gt_zero_gt_coercion:term
  : tactic => `(tactic| exact litnum_bound_derivation_finish_ge_gt $hsrc $hsrc_dn $hdst_dn $hab $hsrc_nf_and_dst_nf_equivalence $hx_sub_a_sub_coercion $hy_sub_b_sub_coercion $hx_ge_zero_ge_coercion $hy_gt_zero_gt_coercion)
...
macro "litnum_bound_derivation_finish"
  ...
  hx_ge_zero_ge_coercion:term
  hy_ge_zero_ge_coercion:term
  : tactic => `(tactic| exact litnum_bound_derivation_finish_ge_ge $hsrc $hsrc_dn $hdst_dn $hab $hsrc_nf_and_dst_nf_equivalence $hx_sub_a_sub_coercion $hy_sub_b_sub_coercion $hx_ge_zero_ge_coercion $hy_ge_zero_ge_coercion)
