...
def h (a b c : ℝ) : a ^ 2 + b ^ 2 + c ^ 2 ≥ a * b + b * c + c * a := by
  ...
  have h6 : a ^ 2 + b ^ 2 + c ^ 2 ≥ a * b + b * c + c * a := by
    ...
    have d13 : a ^ 2 + b ^ 2 + c ^ 2 - a * b = (((-1 : ℤ)) : ℝ) * b * a + b ^ 2 + c ^ 2 + a ^ 2 := by term_derivation_sub
    ...
    have d17 : a ^ 2 + b ^ 2 + c ^ 2 - a * b - b * c = (((-1 : ℤ)) : ℝ) * b * a + b ^ 2 + c ^ 2 + a ^ 2 + (((-1 : ℤ)) : ℝ) * c * b := by term_derivation_sub
    ...
    have d21 : a ^ 2 + b ^ 2 + c ^ 2 - a * b - b * c - c * a = (((-1 : ℤ)) : ℝ) * b * a + (((-1 : ℤ)) : ℝ) * c * a + b ^ 2 + c ^ 2 + a ^ 2 + (((-1 : ℤ)) : ℝ) * c * b := by term_derivation_sub
    have d22 : (0 : ℝ) = 0 := by term_derivation_literal
    have d23 : a ^ 2 + b ^ 2 + c ^ 2 - a * b - b * c - c * a ≥ (0 : ℝ) ↔ (((-1 : ℤ)) : ℝ) * b * a + (((-1 : ℤ)) : ℝ) * c * a + b ^ 2 + c ^ 2 + a ^ 2 + (((-1 : ℤ)) : ℝ) * c * b ≥ (0 : ℝ) := by term_derivation_chaining_separated_list
    ...
    have d44 : a ^ 2 + b ^ 2 + c ^ 2 ≥ a * b + b * c + c * a ↔ (((-1 : ℤ)) : ℝ) * b * a + (((-1 : ℤ)) : ℝ) * c * a + b ^ 2 + c ^ 2 + a ^ 2 + (((-1 : ℤ)) : ℝ) * c * b ≥ (0 : ℝ) := by term_derivation_chaining_separated_list
